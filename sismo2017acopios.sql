...
CREATE TABLE usuarios (
  ...
  PRIMARY KEY (id, username, centro_acopio_id)) ENGINE=InnoDB;
  ...
  ALTER TABLE usuarios ADD INDEX FKcentroacopioId2 (centro_acopio_id), ADD CONSTRAINT FKcentroacopioId2 FOREIGN KEY (centro_acopio_id) REFERENCES centro_acopio (id);